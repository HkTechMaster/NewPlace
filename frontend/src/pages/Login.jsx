  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        navigate(map[result.user.role] || '/admin');
        return;
      }

      // Unknown email → not a staff member
      toast.error('Access denied. This email is not registered as staff. Students use the main login page at /');
    } catch (error) {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.brand}>
          ...
          <div className={styles.brandText}>
            ...
            <span className={styles.brandTagline}>Staff Portal</span>
          </div>
        </div>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.notice}>
            ...
            <span>This portal is for staff only. Staff accounts are created by Super Admin.</span>
          </div>

        </div>

        <p className={styles.footer}>
          PlacePro Staff Portal &nbsp;·&nbsp; Internal Use Only
        </p>
      </div>
    </div>
  );
